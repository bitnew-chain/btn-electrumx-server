...
class TestPubKey(object):
    ...
    def test_from_extended_key_string(self):
        ...
        assert mpubkey.ec_point().x(
        ) == 44977109961578369385937116592536468905742111247230478021459394832226142714624
    ...
    def test_extended_key_string(self):
        ...
        assert chg5.extended_key_string(
            Bitcoin
    ...
    def test_child(self):
        ...
        assert rec_master.address(
            Bitcoin) == '18zW4D1Vxx9jVPGzsFzgXj8KrSLHt7w2cg'
        chg_master = mpubkey.child(1)
        assert chg_master.parent is mpubkey
        assert chg_master.address(
            Bitcoin) == '1G8YpbkZd7bySHjpdQK3kMcHhc6BvHr5xy'
    ...
    def test_identifier(self):
        assert mpubkey.identifier(
        ) == b'\x92\x9c=\xb8\xd6\xe7\xebR\x90Td\x85\x1c\xa7\x0c\x8aE`\x87\xdd'
...
class TestPrivKey(object):
    ...
    def test_secret_exponent(self):
        assert mprivkey.secret_exponent(
    ...
    def test_extended_key_string(self):
        ...
        chg5 = chg_master.child(5)
        assert chg5.WIF(
            Bitcoin) == 'L5kTYMuajTGWdYiMoD4V8k6LS4Bg3HFMA5UGTfxG9Wh7UKu9CHFC'
        ext_key_base58 = chg5.extended_key_string(Bitcoin)
    ...
    def test_child(self):
        ...
        rec0 = rec_master.child(0)
        assert rec0.WIF(
            Bitcoin) == 'L2M6WWMdu3YfWxvLGF76HZgHCA6idwVQx5QL91vfdqeZi8XAgWkz'
        rec19 = rec_master.child(19)
        assert rec19.WIF(
            Bitcoin) == 'KwMHa1fynU2J2iBGCuBZxumM2qDXHe5tVPU9VecNGQv3UCqnET7X'
        chg0 = chg_master.child(0)
        assert chg0.parent is chg_master
        assert chg0.WIF(
            Bitcoin) == 'L4J1esD4rYuBHXwjg72yi7Rw4G3iF2yUHt7LN9trpC3snCppUbq8'
